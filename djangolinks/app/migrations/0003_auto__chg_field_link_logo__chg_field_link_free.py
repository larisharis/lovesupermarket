...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Link.logo'
        db.alter_column('app_link', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'Link.free'
        db.alter_column('app_link', 'free', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'Link.logo'
        db.alter_column('app_link', 'logo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Link.free'
        db.alter_column('app_link', 'free', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'app.link': {
            ...
            'free': ('django.db.models.fields.CharField', [], {'default': "'No'", 'max_length': '3'}),
            'free_trial': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
