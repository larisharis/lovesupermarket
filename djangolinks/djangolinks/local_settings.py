...
DATABASES = {
    'default': {
        ...
        'NAME': 'djangolinks',                      # Or path to database file if using sqlite3.
...
SITE_TWITTER_ID='demo_dl'

ADMINS = (
    ('admin', 'prof.math@gmail.com'),
)

# send email notification when new link has been posted
INFORM_NEW_LINKS=False
...
DISQUS_WEBSITE_SHORTNAME = 'lovesupermaket'
...
TWITTER_CONSUMER_KEY         = 'qxVBpyoFPEs8Zp6droCeCg'
TWITTER_CONSUMER_SECRET      = 'ywB0FPZI7Y445BlDhrbJHUFykXs1mQGViA0wHPnu8'
FACEBOOK_APP_ID              = ''
FACEBOOK_API_SECRET          = ''
